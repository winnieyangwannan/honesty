...
def get_lying_honest_accuracy_and_plot(cfg, model_base, dataset):
    ...
    fig.write_html(artifact_dir + os.sep + model_name + '_' + 'honest_lying_pca_layer.html')
...
def contrastive_extraction_intervention_generation_and_plot_pca(cfg, model_base, dataset_train, dataset_test):
    source_layer = cfg.source_layer
    tokenize_fn = model_base.tokenize_statements_fn
    ...
    # 3. lying_intervention_and_plot_pca
    print("start intervention")
    generate_with_intervention_cache_contrastive_activations_and_plot_pca(cfg,
                                                                          model_base,
                                                                          tokenize_fn,
                                                                          statements_test,
                                                                          mean_diff[source_layer],
                                                                          activations_honest,
                                                                          activations_lying,
                                                                          labels=labels_test)
...
def run_pipeline(model_path):
    ...
    contrastive_extraction_intervention_generation_and_plot_pca(cfg, model_base, dataset_train, dataset_test)
